...
- (void)viewDidLoad {
	...
	//Get network status
	self.httpClient = [[AFHTTPRequestOperationManager alloc]initWithBaseURL:[NSURL URLWithString:@"http://nba.hupu.com/"]];
...
- (void)testImageFetch {
	...
	NSString *urlStr = @"https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/img/logo/logo_white_fe6da1ec.png";
